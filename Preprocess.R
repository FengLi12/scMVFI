normalized_data <- function (raw_Data, min_Reads = 0.3, min_Cell = 0.1, min_Gene = 1000,
                             log = T)
{
...
normalized=normalized_data(raw_Data, min_Reads = 0.3, min_Cell = 0.1, min_Gene = 1000,log = T)
